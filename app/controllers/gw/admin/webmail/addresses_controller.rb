...
class Gw::Admin::Webmail::AddressesController < Gw::Controller::Admin::Base
  ...
  def candidate_import
    ...
    header = [:name, :kana, :email,
          :company_name, :company_kana, :official_position, :company_tel, :company_fax, :company_zip_code, :company_address,
  ...
  def export
    ...
    header = ['表示名', '電子メール アドレス',
        '自宅の郵便番号', '自宅の都道府県', '自宅の市区町村', '自宅の番地', '自宅電話番号 :', '自宅ファックス', '携帯電話 ', '個人 Web ページ',
